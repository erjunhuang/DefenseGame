using TargetDefense.MeshCreator;
using UnityEngine;

namespace TargetDefense.Nodes
{
    /// <summary>
   ...
   // [RequireComponent(typeof(Collider2D))]
    public class Node : MonoBehaviour
    {
        ...
        void OnDrawGizmos()
        {
           //Gizmos.DrawIcon(transform.position, "movement_node.png", true);
            // Gizmos.DrawIcon(transform.position + Vector3.zero, "movement_node.png", true);
        }
