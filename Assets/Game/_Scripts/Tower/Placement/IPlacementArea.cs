...
namespace TargetDefense.Targets.Placement
{
	...
	public interface IPlacementArea
	{
        ...
        void SetController(Transform controller);
        /// <summary>
		...
		/// </summary>
		IntVector2 WorldToGrid(Vector3 worldPosition, IntVector2 sizeOffset = default(IntVector2));

		/// <summary>
		/// Calculates the snapped world position from a given grid position
		/// </summary>
		Vector3 GridToWorld(IntVector2 gridPosition, IntVector2 sizeOffset = default(IntVector2));
		...
		TowerFitStatus Fits(IntVector2 gridPos, IntVector2 size = default(IntVector2));
